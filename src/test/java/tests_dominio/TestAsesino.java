...
public class TestAsesino {
	...
	public void testProbEvasion(){
		...
		Assert.assertTrue(0.3==h.getCasta().getProbabilidadEvitarAtaque());
		h.habilidadCasta2(null);
		Assert.assertEquals(0.45, h.getCasta().getProbabilidadEvitarAtaque(), 0.01);
		h.habilidadCasta2(null);
		Assert.assertTrue(0.5==h.getCasta().getProbabilidadEvitarAtaque());
	}
}
